        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute left-0 bg-[#1A1A1A] text-white mt-2 py-2 w-64 shadow-lg rounded z-50 opacity-0 group-hover:opacity-100 group-hover:pointer-events-auto pointer-events-none transition duration-200">
