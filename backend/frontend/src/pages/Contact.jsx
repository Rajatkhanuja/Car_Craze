...
const Contact = () => {
  ...
  return (
    <>
      ...
      <div className="contact-details">
        <p>
          <strong>Car Craze</strong>
        </p>
        <p>
          Near Bhairavgarh Resort, 200 Ft Khelgaon Road, Sukher, Udaipur,
          Rajasthan 313001
        </p>
        <p>
          <strong>Email:</strong>{" "}
          <a href="mailto:crazeudr@gmail.com">carcrazeudr@gmail.com</a>
        </p>
        <p>
          <strong>Phone:</strong> <a href="tel:+918094559521">+91 8094559521</a>
        </p>
      </div>
  ...
  <li><Link to="/contact">Contact</Link></li>
    ...
    <div class="footer-section contact">
      <h3>Contact Us</h3>
      <p><i class="fas fa-phone"></i> +91 8094559521</p>
      <p><i class="fas fa-envelope"></i> carcrazeudr@gmail.com</p>
      <p><i class="fas fa-map-marker-alt"></i> Near Bhairavgarh Resort, 200 Ft Khelgaon Road, Sukher, Udaipur, Rajasthan 313001</p>
    </div>
  </div>
